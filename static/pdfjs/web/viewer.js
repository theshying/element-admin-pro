 ...
 *
 * 1. 2019-01-22 by lanbo 修改当前语言设置，让viewer显示为指定的语言
 * 2. 2019-02-15 by lanbo pdf文件获取失败时，显示服务端返回的提示信息
 */
/**
...
{
  defaultOptions.locale = {
    value: window.pdfViewerCustomLocale || (typeof navigator !== 'undefined' ? navigator.language : 'en-US'),
    kind: OptionKind.VIEWER
  };
}
